...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarketingSlider'
        db.create_table(u'marketing_marketingslider', (
        ...
        db.send_create_signal(u'marketing', ['MarketingSlider'])


    def backwards(self, orm):
        # Deleting model 'MarketingSlider'
        db.delete_table(u'marketing_marketingslider')
    ...
    models = {
        ...
        u'marketing.marketingslider': {
            'Meta': {'ordering': "['order', 'start_date', 'end_date']", 'object_name': 'MarketingSlider'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
