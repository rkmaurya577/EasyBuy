...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field product_variations on 'CartItem'
        m2m_table_name = db.shorten_name(u'carts_cartitem_product_variations')
    ...
    def backwards(self, orm):
        # Removing M2M table for field product_variations on 'CartItem'
        db.delete_table(db.shorten_name(u'carts_cartitem_product_variations'))
    ...
    models = {
        ...
        u'carts.cartitem': {
            ...
            'product_variations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['products.ProductVariation']", 'null': 'True', 'blank': 'True'}),
